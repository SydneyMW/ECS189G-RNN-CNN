...
class Dataset_Loader(dataset):
    ...
    def load(self):
        ...
        if self.dataset_name == 'cora':
            ...
            idx_train = range(140)              # TRAIN WITH 140 INSTANCES (20/class)
            idx_test = range(200, 1250)         # TEST WITH 1050 INSTANCES (150/class)
            idx_val = range(1250, 1500)
        elif self.dataset_name == 'citeseer':
            idx_train = range(120)              # TRAIN WITH 120 INSTANCES (20/class)
            idx_test = range(200, 1400)         # TEST WITH 1200 INSTANCES (200/class)
            idx_val = range(1400, 1500)
        elif self.dataset_name == 'pubmed':
            idx_train = range(60)               # TRAIN WITH 60 INSTANCES (20/class)
            idx_test = range(6300, 6900)        # TEST WITH 600 INSTANCES (200/class)
